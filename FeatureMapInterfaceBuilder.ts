...
export const objectToString = (properties: [string, string?][], prefix?: string): string => `${prefix || ""}{
...
export const createConstantFromFeatureMap = (featureMap: FeatureMap) => {
    return createConstantString(featureMap.productName, 
